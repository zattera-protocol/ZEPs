...
이 ZEP는 블록 생산자가 Ethereum 호환 체인의 ERC-721 NFT 소유권을 증명하도록 요구하는 증인 인증 시스템을 제안합니다. 증인은 자신의 Zattera 계정과 등록된 NFT를 소유한 Ethereum 주소를 연결하는 암호화 증명을 주기적으로 제출해야 합니다. 오라클 서비스는 증인이 블록 생산 자격을 얻기 전에 온체인 소유권을 검증합니다.
