...
#define ZATTERA_DEFAULT_DOLLAR_INTEREST_RATE    (10*ZATTERA_1_PERCENT)
#define ZATTERA_CONTENT_REWARD_PERCENT          (75*ZATTERA_1_PERCENT)
#define ZATTERA_VESTING_FUND_PERCENT            (15*ZATTERA_1_PERCENT)
#define ZATTERA_DOLLAR_STOP_PERCENT             (5*ZATTERA_1_PERCENT)
#define ZATTERA_DOLLAR_START_PERCENT            (2*ZATTERA_1_PERCENT)
